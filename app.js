/*---------------------------------------------------*/
/*The first part of the code runs the index.html file*/
/*---------------------------------------------------*/
...
// Everything in 'stuff' will be "mounted" in '/public'
// app.use('/public', express.static(path.join(__dirname, 'stuff')));
...
/*------------------------------------------------------------------------------------*/
/*The second part actually makes the connection between the Leap Motion and the Sphero*/
/*------------------------------------------------------------------------------------*/
